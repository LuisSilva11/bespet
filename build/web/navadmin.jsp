...
<html>
    <head>
        <link href="css/estilo_dash.css" rel="stylesheet" type="text/css"/>
            ...
            <dl class="nav-list">
                ...
                <li>
                    <a href="serviciosTerminados.jsp">
                        <i class='bx bx-folder' ></i>
                        <span class="links_name">Servicios terminados</span>
                    </a>
                    <span class="tooltip">Servicios terminados</span>
                ...
                <div class="logo-details">
                    ...
                    <div class="logo_name" style="font-size: 15px"><%= Usuario %></div>

...
<html>
    ...
    <body>
        ...
        <section class="home-section">
            ...
            <p>Inicio >> Servicios Terminados</p>
            </div>
            <br>
            <div class="container">
                <h1 class="title"><b>Servicios Terminados</b></h1><br>
                ...
                <br>
                <form class="pdf" method="post" action="GenerarPDFasignarServicios.jsp" target="_black">
